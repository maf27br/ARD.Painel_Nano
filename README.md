# Painel Informativo usando Arduino Nano e Display OLED 128x64
Projeto protótipo para escultura lander usando:
  1. Arduino Nano
  2. BME 180
  3. Display Oled i2c 128x64
  4. RTC 1307 com AT24C32

O sketch registra além da data/hora, temperatura, umidade, pressão e altitude, medindo a bateria incorporada.
Grava um log de 16 bytes na memória EEPROM externa AT24C32
Grava na eprom interna do RTC a ultima posição de memória na EEPROM

## Esquema
![PainelNano_bb](https://github.com/maf27br/ARD.Painel_Nano/assets/68168344/56e6be68-3406-4f41-9ab2-ef68fa8f0590)

## Montagem
![20240530_185115](https://github.com/maf27br/ARD.Painel_Nano/assets/68168344/7d5346ea-8f0e-4275-8b55-732f5ef48e73)

![20240530_185122](https://github.com/maf27br/ARD.Painel_Nano/assets/68168344/7a9007e4-6ee7-42c6-acc7-3d6afb99ca1f)
...
const float maxBateria = 5.0;  //teste com bateria de 5v
const float minBateria = 4.5;  
...
void setup(void) {
  ...
  if (rtc.readnvram(40) == 77){ //VERIFICA SE TEM ULTIMA POSICAO GRAVADA NO RTC
